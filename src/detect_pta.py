...
def main():
    ...
    topic_cars_count = "pta/car/detection/count"
    topic_person_count = "pta/person/detection/count"
    topic_planes_count = "pta/plane/detection/count"
    topic_trains_count = "pta/train/detection/count"
    topic_trucks_count = "pta/truck/detection/count"

    # Define MQTT topics for confidence scores
    topic_cars_confidence = "pta/car/detection/confidence"
    topic_person_confidence = "pta/person/detection/confidence"
